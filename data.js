...
"lakhely":"Kocsér",
"neme":"Fiú",
"telefonszam":"06304429214",
"image":"img/czeczon.jpg"
},

{"id":2,
"nev":" Balogh Adam",
"lakhely":"Spar mögött Kecskemét",
"neme":"Fiú",
"telefonszam":"06304442544",
"image":"img/adam.jpg"
    },
]*/
...
<div class="border border-danger" data-id="${obj.id}" onclick="kuka(this)"><i class="fa-solid fa-trash"></i></div> `
...
show()
    ...
    /*for(myAdatok in localStorage) {
        delete localStorage[myAdatok];
    }
    document.querySelector('.nev1').innerHTML=""
*/
